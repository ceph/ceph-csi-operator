...
const (
	...
	SnapshotMetadataTLSSecretName         = "csi-snapshot-metadata-server-certs"
...
var SnapshotMetadataServerCertsVolume = corev1.Volume{
	Name: snapshotMetadataServerCertsVolumeName,
	VolumeSource: corev1.VolumeSource{
		Secret: &corev1.SecretVolumeSource{
			SecretName: SnapshotMetadataTLSSecretName,
		},
	},
}

...
var _ = Describe("ClientProfileMapping Controller", func() {
	Context("When reconciling a resource", func() {
		...
		clientprofilemapping := &csiv1beta1.ClientProfileMapping{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &csiv1beta1.ClientProfileMapping{
					ObjectMeta: metav1.ObjectMeta{
						Name:      resourceName,
						Namespace: "default",
					},
					Spec: csiv1beta1.ClientProfileMappingSpec{
						Mappings: []csiv1beta1.MappingsSpec{
							{

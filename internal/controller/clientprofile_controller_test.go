...
var _ = Describe("ClientProfile Controller", func() {
	Context("When reconciling a resource", func() {
		...
		clientProfile := &csiv1b1.ClientProfile{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &csiv1b1.CephConnection{
					ObjectMeta: metav1.ObjectMeta{
						Name:      cephConnectionName,
						Namespace: namespaceName,
					},
					Spec: csiv1b1.CephConnectionSpec{
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &csiv1b1.ClientProfile{
					ObjectMeta: metav1.ObjectMeta{
						Name:      resourceName,
						Namespace: "default",
					},
					// TODO(user): Specify other spec details if needed.
					Spec: csiv1b1.ClientProfileSpec{
		...
		AfterEach(func() {
			...
			cephConnection := &csiv1b1.CephConnection{}
